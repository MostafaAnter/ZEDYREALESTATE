...
import com.zedy.realestate.activities.SplashActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (!new RealEstatePrefStore(this).getPreferenceValue(Constants.userId).trim().isEmpty()){
    ...
    private void sendNotification(String messageBody) {
        ...
        Intent intent = intent = new Intent(this, SplashActivity.class);
